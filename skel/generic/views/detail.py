...
from skel.generic.views.base import GenericView
...
class DetailView(GenericView):
    ...
    def get_template_names(self, request, obj):
        ...
        # Add the template for this object's primary key.
        names.append('%s/%s_%s_detail.html' % (obj._meta.app_label, 
                                               obj._meta.object_name.lower(),
                                               obj.pk))

        # Add the template for this object's slug if it exists.
        slug_field = self.get_slug_field(request)
        ...
        # The less-specific option is the default <app>/<model>_detail.html
        names.append('%s/%s_detail.html' % (obj._meta.app_label, 
                                            obj._meta.object_name.lower()))

        # The lesser-specific option is the default <app>/detail.html
        names.append('%s/detail.html' % obj._meta.app_label)

        # The least-specific option is the default generic/detail.html
        names.append('generic/detail.html')
